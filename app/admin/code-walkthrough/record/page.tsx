...
import { saveTestRecording } from "@/app/(public)/test-recording/actions";
...
export default function CodeWalkthroughRecordPage() {
  ...
  const handleSaveRecording = async (
    ...
    toast.success("Walkthrough saved to database successfully!");
  };
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <div className="font-medium">Walkthrough {index + 1}</div>
        ...
        {selectedRecording && (
          <div className="bg-card rounded-lg border p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold">Preview Walkthrough</h2>
              <Button
                variant="outline"
            ...
            <div className="space-y-4">
              <div className="text-sm text-muted-foreground">
                Preview your walkthrough before saving to the database. You can
                pause, edit code, and resume playback.
              </div>
