...
function LogoSVG({
  ...
  // Use CSS variables for theme-adaptive colors that work immediately on load
  ...
  return (
    <svg
      ...
      className={className}
    >
      <g id="logogram" fill="var(--sidebar-ring)" suppressHydrationWarning>
...
export function AppLogoText() {
  return <span className="text-base font-semibold text-primary">Zo</span>;
}
